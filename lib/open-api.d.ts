...
export interface OpenAPI3 {
    ...
    components?: {
        schemas: {
            [key: string]: undefined | JSONSchema;
        };
    };
}
 ...
 */
export declare type SupportedMethods = 'get' | 'post' | 'put' | 'patch' | 'delete' | 'head' | 'options' | 'trace';
export declare type Methods = Partial<Record<SupportedMethods, Operation>>;
...
export declare const validate: (contracts: OpenAPI3) => boolean;
